                ...
                children: [
                      ...
                      builder: (context, imageProvider, child) {
                        return Column(
                          children: [
                            ...
                            const SizedBox(height: 10),
                            Text("Tap to select profile photo", style: TextStyle(color: Colors.black54, fontSize: 18, fontWeight: FontWeight.w500),),
                          ],
                        );
                      },
                    ),
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 5,),
                      Text('First Name', style: TextStyle(color: Colors.black54, fontSize: 18, fontWeight: FontWeight.bold),),
                    ],
                  ),
                  Container(
                ...
                //  const SizedBox(height: 10),
                  Row(
                    children: [
                      Icon(Icons.person_2_outlined, color: Colors.black54,),
                      SizedBox(width: 5,),
                      Text('Last Name', style: TextStyle(color: Colors.black54, fontSize: 18, fontWeight: FontWeight.bold),),
                    ],
                  ),
                ...
                //  const SizedBox(height: 10),
                  Row(
                    children: [
                      Icon(Icons.person_2_outlined, color: Colors.black54,),
                      SizedBox(width: 5,),
                      Text('Nick Name', style: TextStyle(color: Colors.black54, fontSize: 18, fontWeight: FontWeight.bold),),
                    ],
                  ),
                  Container(
                    margin: const EdgeInsets.only(bottom: 20),
                  ...
                  Row(
                    children: [
                      Icon(Icons.cake_outlined, color: Colors.black54,),
                      SizedBox(width: 5,),
                      Text('Birthday', style: TextStyle(color: Colors.black54, fontSize: 18, fontWeight: FontWeight.bold),),
                    ],
                  ),
                    ...
                    child: TextField(
                      ...
                      onTap: () async {
                        ...
                        final DateTime? picked = await showDatePicker(
                          ...
                          //         primary: login, // Confirm button color
                          //         onPrimary: Colors.black87, // Text color on primary
                  ...
                  Row(
                    children: [
                      Image.asset('image/gender.png', height: 20,color: Colors.black54,),

                      SizedBox(width: 5,),
                      Text('Gender', style: TextStyle(color: Colors.black54, fontSize: 18, fontWeight: FontWeight.bold),),
                    ],
                  ),
                          ...
                          builder: (BuildContext context) {
                            return Padding(
                              ...
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Text('Select Your Gender', style: Font.boldFont,),
                                  ListTile(
                                  ...
                                  ListTile(
                                    ...
                                    onTap: () {
                                      genderController.text = "Prefer Not to Answer";
                                      selectedGender = "Prefer Not to Answer";
                                      Navigator.pop(context);
                                    },
                                  ),
                                ],
                  ...
                  Row(
                    children: [
                      Image.asset('image/seeing.png', height: 30, color: Colors.black54,),


                      SizedBox(width: 5,),
                      Text('Looking For', style: TextStyle(color: Colors.black54, fontSize: 18, fontWeight: FontWeight.bold),),
                    ],
                  ),
                          ...
                          builder: (BuildContext context) {
                            return Padding(
                              ...
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Text('Looking For', style: Font.boldFont,),
                                  ListTile(
                                  ...
                                  ListTile(
                                    ...
                                    onTap: () {
                                      lookingController.text = "Friendship";
                                  ...
                                  ListTile(
                                    title: const Text("Prefer Not to Answer"),
                                    onTap: () {
                                      lookingController.text = "Prefer Not to Answer";
                                      selectedLooking = "Prefer Not to Answer";
                                      Navigator.pop(context);
                                    },
                                  ),
                                ],
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 5,),
                      Text('Live In', style: TextStyle(color: Colors.black54, fontSize: 18, fontWeight: FontWeight.bold),),
                    ],
                  ),
                    ...
                    builder: (context, cityProvider, child) {
                      return Container(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          items: cityProvider.belgiumCities.map((String city) {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text("NEXT", style: TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontSize: 20),),
                    ),
                  ),
                  const SizedBox(height: 10),
